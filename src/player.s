...
; wait until all controller buttons are unpressed
.proc wait_pad_allup
...
wait_button_left:
  lda cur_keys
  and #>KEY_LEFT
  bne wait_button_left
  wdm 0

wait_button_right:
  lda cur_keys
  and #>KEY_RIGHT
  bne wait_button_right
  wdm 0
...
wait_button_rbump:
  lda cur_keys
  and #>KEY_R
  bne wait_button_rbump
  wdm 0

wait_button_lbump:
  lda cur_keys
  and #>KEY_L
  bne wait_button_lbump
  wdm 0
